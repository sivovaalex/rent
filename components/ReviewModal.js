...
export default function ReviewModal({ isOpen, onClose, booking, currentUser, onSubmit }) {
  // Защита от отсутствия currentUser
  useEffect(() => {
    ...
    try {
      ...
      const res = await fetch('/api/reviews', {
        ...
        body: JSON.stringify({
          ...
          photos: reviewForm.photos || [] // Фотографии необязательны
        })
      });

...
export default function ReviewList({ reviews = [], currentUser, onReply }: ReviewListProps) {
          ...
          <CardContent className="p-4">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                {(review as Review & { photos?: string[] }).photos && (review as Review & { photos?: string[] }).photos!.length > 0 && (
                  <div className="mt-3 grid grid-cols-3 gap-2">
                    {(review as Review & { photos?: string[] }).photos!.slice(0, 3).map((photo, index) => (
                    ...
                    {(review as Review & { photos?: string[] }).photos!.length > 3 && (

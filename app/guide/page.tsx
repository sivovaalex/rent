          ...
          >
            <Card>
              ...
              <CardContent className="space-y-5">
                ...
                <Step number={3} title="Арендатор">
                  После регистрации вы становитесь арендатором — можете просматривать каталог и бронировать вещи без дополнительных подтверждений.
                </Step>
                <Step number={4} title="Верификация и роль арендодателя">

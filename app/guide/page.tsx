...
const faqItems = [
  {
    q: 'Что такое Аренда Про?',
    a: 'Аренда Про — это платформа для аренды и сдачи в аренду вещей между пользователями. Вы можете арендовать электронику, стрим-оборудование, инструменты, одежду, спортивный инвентарь и многое другое.',
  },
  {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Всё, что нужно знать о работе с платформой Аренда Про</p>
      </div>

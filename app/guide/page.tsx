...
const faqItems = [
  {
    q: 'Что такое Аренда PRO?',
    a: 'Аренда PRO — это платформа для аренды и сдачи в аренду вещей между пользователями. Вы можете арендовать электронику, стрим-оборудование, инструменты, одежду, спортивный инвентарь и многое другое.',
  },
  {
  ...
  },
  {
    ...
    a: 'Перейдите в профиль и загрузите документ, подтверждающий вашу личность (паспорт или водительское удостоверение). Модератор проверит заявку в течение 24 часов. Верификация повышает доверие к вашему профилю.',
  },
  {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600">Всё, что нужно знать о работе с платформой Аренда PRO</p>
      </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-5">
                <Step number={1} title="Регистрация">
                  Нажмите «Зарегистрироваться» на главной странице. Укажите номер телефона или email, придумайте пароль. Введите SMS-код для подтверждения.
                </Step>
                <Step number={2} title="Вход в аккаунт">
                  Используйте телефон/email и пароль для входа. Если забыли пароль — воспользуйтесь функцией восстановления.
                </Step>
                <Step number={3} title="Выбор роли">
                  После регистрации вы можете выбрать роль: <Badge variant="outline" className="mx-1">Арендатор</Badge> — для аренды вещей, <Badge variant="outline" className="mx-1">Арендодатель</Badge> — для сдачи своих вещей в аренду. Роль можно сменить в профиле.
                </Step>
                <Step number={4} title="Верификация">
                  Для повышения доверия пройдите верификацию: загрузите документ, удостоверяющий личность, в разделе «Профиль». Верифицированные пользователи получают специальный значок и приоритет при бронировании.
                </Step>
              </CardContent>
            </Card>
          </section>
            ...
            <Card>
              ...
              <CardContent className="space-y-5">
                ...
                <Step number={2} title="Уведомления о сообщениях">
                  Если вы не прочитали сообщение в течение 30 минут, вам придёт уведомление в Telegram, VK или по email (в зависимости от настроек). Количество непрочитанных сообщений отображается на иконке чата.
                </Step>
            ...
            <Card>
              ...
              <CardContent className="space-y-5">
                ...
                <Step number={2} title="Верификация пользователей">
                  Проверяйте заявки на верификацию: просматривайте загруженные документы и подтверждайте или отклоняйте их. Напоминание приходит, если заявка ожидает более 30 минут.
                </Step>

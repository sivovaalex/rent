...
export async function sendPasswordResetEmail(
  ...
  const subject = 'Сброс пароля - Аренда PRO';

  const text = `
Здравствуйте${userName ? `, ${userName}` : ''}!

Вы запросили сброс пароля для вашего аккаунта на платформе Аренда PRO.
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #e5e7eb; border-top: none;">
    ...
    <p>Вы запросили сброс пароля для вашего аккаунта на платформе Аренда PRO.</p>
...
export async function sendPasswordChangedEmail(
  ...
  const subject = 'Пароль изменён - Аренда PRO';

  const text = `
Здравствуйте${userName ? `, ${userName}` : ''}!

Пароль для вашего аккаунта на платформе Аренда PRO был успешно изменён.
...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  ...
  <div style="background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px; border: 1px solid #e5e7eb; border-top: none;">
    ...
    <p>Пароль для вашего аккаунта на платформе Аренда PRO был успешно изменён.</p>
